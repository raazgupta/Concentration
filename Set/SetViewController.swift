...
class SetViewController: UIViewController {
    ...
    private func updateViewFromModel() {
        ...
        if let displayedDeck = setGame?.displayedDeck {
            ...
            if setGame?.remainingCards != nil && deckLabel != nil {
            ...
            if aiSwitch != nil && multiPlayerSwitch != nil && discardLabel != nil {
                if aiSwitch.isOn {
    ...
    @IBAction func tapCard(_ sender:
